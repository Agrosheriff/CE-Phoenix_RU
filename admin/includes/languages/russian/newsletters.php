...
define('ERROR_NEWSLETTER_TITLE', '<b>Ошибка:</b> Тема обязательна');
define('ERROR_NEWSLETTER_MODULE', '<b>Ошибка:</b> Модуль обязателен');
define('ERROR_REMOVE_UNLOCKED_NEWSLETTER', '<b>Ошибка:</b> Заблокируйте информационное письмо перед его удалением.');
define('ERROR_EDIT_UNLOCKED_NEWSLETTER', '<b>Ошибка:</b> Заблокируйте информационное письмо перед его редактированием.');
define('ERROR_SEND_UNLOCKED_NEWSLETTER', '<b>Ошибка:</b> Заблокируйте информационное письмо перед его отправкой.');
define('ERROR_NEWSLETTER_MODULE_NOT_EXISTS', '<b>Ошибка:</b> этот модуль отсутствует.');
