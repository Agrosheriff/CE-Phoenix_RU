...
define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_BOX_NOTIFY', 'Уведомить меня об изменениях товара <b>%s</b>');
define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_BOX_NOTIFY_REMOVE', 'Не уведомлять меня об изменениях товара <b>%s</b>');
