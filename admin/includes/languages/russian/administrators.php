...
define('TABLE_HEADING_HTPASSWD', 'Безопасность с htpasswd');
...
define('TEXT_INFO_DELETE_INTRO', 'Хоите удалить этого Администратора?');
