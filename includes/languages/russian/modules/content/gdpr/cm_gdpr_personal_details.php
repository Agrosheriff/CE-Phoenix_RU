...
define('MODULE_CONTENT_GDPR_PERSONAL_DETAILS_GENDER', 'Пол');
define('MODULE_CONTENT_GDPR_PERSONAL_DETAILS_GENDER_M', 'Мужской');
define('MODULE_CONTENT_GDPR_PERSONAL_DETAILS_GENDER_F', 'Женский');

define('MODULE_CONTENT_GDPR_PERSONAL_DETAILS_UNKNOWN', 'Неизвестно');

define('MODULE_CONTENT_GDPR_PERSONAL_DETAILS_DOB', 'Дата рождения');
