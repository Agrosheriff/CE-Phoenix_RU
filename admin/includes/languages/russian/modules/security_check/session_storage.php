...
define('WARNING_SESSION_DIRECTORY_NOT_WRITEABLE', 'Невозможно записывать файлы в каталог сессий: ' . tep_session_save_path() . ' . Сессии не будут работать, пока необходимые права доступа не будут установлены.');
?>