...
define('ENTRY_TESTIMONIAL', 'Рекомендации:');
define('TEXT_INFO_DELETE_TESTIMONIAL_INTRO', 'Вы уверены, что хотите удалить эту рекомендацию?');
define('TEXT_INFO_DATE_ADDED', 'Добавлено: %s');
define('TEXT_INFO_LAST_MODIFIED', 'Изменено: %s');

define('TEXT_INFO_TESTIMONIAL_AUTHOR', 'Автор: %s');
define('TEXT_INFO_TESTIMONIAL_SIZE', 'Размер текста: %s');
define('TEXT_INFO_TESTIMONIAL_STATUS', 'Статус рекомендаций');
define('TEXT_TESTIMONIAL_PUBLISHED', 'Опубликовано');
define('TEXT_TESTIMONIAL_NOT_PUBLISHED', 'Неопубликовано');
