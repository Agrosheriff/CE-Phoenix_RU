...
define('TEXT_PRODUCTS_LARGE_IMAGE_DELETE_TITLE', 'Удалить большую картинку товара?');
define('TEXT_PRODUCTS_LARGE_IMAGE_CONFIRM_DELETE', 'Подтвердите удаление.');
define('TEXT_PRODUCTS_URL', 'URL товара:');
define('TEXT_PRODUCTS_URL_WITHOUT_HTTP', '<small>(включая http:// или https:// )</small>');
