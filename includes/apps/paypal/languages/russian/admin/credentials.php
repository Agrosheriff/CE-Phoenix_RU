...
paypal_live_title = Текущие учетные данные
paypal_live_api_username = API Имя пользователя
paypal_live_api_password = API Пароль
paypal_live_api_signature = API Подпись
paypal_live_merchant_id = Идентификатор продавца Merchant ID
paypal_live_merchant_id_desc = Идентификатор продавца The Merchant-ID является идентификатором продавца PayPal, указанным в настройках профиля учетной записи PayPal.
...
paypal_sandbox_api_signature = API Подпись
paypal_sandbox_merchant_id = Merchant ID Идентификатор продавца
paypal_sandbox_merchant_id_desc = Идентификатор продавца Merchant ID - это идентификатор продавца PayPal, который указан в настройках профиля учетной записи PayPal.
...
payflow_live_user = Пользователь
payflow_live_password = Пароль

payflow_sandbox_title = Sandbox Учетные данные
