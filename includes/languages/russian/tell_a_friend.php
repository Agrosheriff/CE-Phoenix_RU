...
define('TEXT_EMAIL_SUCCESSFUL_SENT', 'Ваше письмо о <strong>%s</strong> успешно отправлено <strong>%s</strong>.');

define('TEXT_EMAIL_SUBJECT', 'Ваш друг %s рекомендует Вам... %s');
...
define('ERROR_ACTION_RECORDER', 'Ошибка: Сообщение на e-mail адрес Вашего друга уже было отправлено. Попробуйте повторить через %s минут.');
?>
