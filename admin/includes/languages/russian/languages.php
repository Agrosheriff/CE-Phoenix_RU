...
define('ERROR_REMOVE_DEFAULT_LANGUAGE', 'Ошибка: Язык, установленный по умолчанию не может быть удален. Установите другой язык по умолчанию и попробуйте снова удалить ненужный язык.');
?>
