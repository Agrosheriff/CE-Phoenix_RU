...
*/
  ...
  define('MODULE_NAVBAR_SHOPPING_CART_CONTENTS', '<i title="Корзина" class="fas fa-shopping-cart fa-fw"></i><span class="d-inline d-sm-none d-md-inline"><span class="cart-count">Товаров в корзине: %1$s</span> <span class="caret"></span>');
  define('MODULE_NAVBAR_SHOPPING_CART_NO_CONTENTS', '<i class="fas fa-shopping-cart fa-fw"></i> Корзина пуста');
  define('MODULE_NAVBAR_SHOPPING_CART_HAS_CONTENTS', '<span class="cart-count">%s</span> штук, <span class="cart-value">%s</span>');
