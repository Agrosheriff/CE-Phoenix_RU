...
define('TEXT_INFO_COUNTRY_NAME', 'Название: %s');
define('TEXT_INFO_COUNTRY_CODE_2', 'Код по ISO (2): %s');
define('TEXT_INFO_COUNTRY_CODE_3', 'Код по ISO (3): %s');
define('TEXT_INFO_ADDRESS_FORMAT', 'Формат Адреса: %s');
