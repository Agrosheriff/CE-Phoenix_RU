...
define('TABLE_HEADING_COUNTRY_ZONE', 'Налоговая зона');
...
define('TEXT_INFO_HEADING_NEW_SUB_ZONE', 'Новая субзона');
define('TEXT_INFO_NEW_SUB_ZONE_INTRO', 'Введите, пожалуйста, информацию по новой субзоне');

define('TEXT_INFO_HEADING_EDIT_SUB_ZONE', 'Редактировать субзону');
define('TEXT_INFO_EDIT_SUB_ZONE_INTRO', 'Сделайте необходимые изменения');

define('TEXT_INFO_HEADING_DELETE_SUB_ZONE', 'Удалить субзону');
define('TEXT_INFO_DELETE_SUB_ZONE_INTRO', 'Вы действительно хотите удалить эту субзону?');
