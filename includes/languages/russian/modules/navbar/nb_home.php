...
define('MODULE_NAVBAR_HOME_DESCRIPTION', 'Показать ссылку на Главную страницу в Панели навигации. <div class="alert alert-warning">Если вы хотите, чтобы кнопка «Домой» постоянно отображалась (даже если остальная часть меню свернута, например, в окне просмотра XS), вы можете использовать вместо этого модуль Бренд Вашей фирмы.</div>');
