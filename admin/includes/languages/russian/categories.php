...
define('TEXT_NEW_PRODUCT', 'Новые Товары <small>в %s</small>');
define('TEXT_EXISTING_PRODUCT', 'Редактировать товар в категории <small>%s</small>');
...
define('TEXT_PRODUCTS_LARGE_IMAGE_DELETE_TITLE', 'Удалить картинку из галереи?');
define('TEXT_PRODUCTS_LARGE_IMAGE_CONFIRM_DELETE', 'Подтвердите удаление картинки из галереи.');
...
define('TEXT_CATEGORIES_DESCRIPTION', 'Описание категории:<br><small>показано на странице категории</small>');
...
define('TEXT_EDIT_CATEGORIES_SEO_DESCRIPTION', 'Редактировать Категории Meta Description для SEO:<br><small>Изменить &lt;description&gt; Meta Element.</small>');
define('TEXT_CATEGORIES_SEO_KEYWORDS', 'Категории.  Meta Keywords for SEO:<br><small>Add a &lt;keyword&gt; Meta Element.<br>Слова ввести через запятую.</small>');
