...
define('TEXT_INFO_LANGUAGE_IMAGE', 'Картинка: %s');
define('TEXT_INFO_LANGUAGE_DIRECTORY', 'Директория: %s<b>%s</b>');
define('TEXT_INFO_LANGUAGE_SORT_ORDER', 'Порядок Сортировки: %s');
